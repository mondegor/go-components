...
// WithCaptionPrefix - устанавливает опцию captionPrefix для schedule.TaskScheduler.
...
// WithTaskCleanNoticesOpts - устанавливает опцию taskCleanerOpts для schedule.TaskScheduler.
func WithTaskCleanNoticesOpts(value ...task.Option) Option {
	return func(o *options) {
