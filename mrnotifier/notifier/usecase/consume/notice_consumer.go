...
func (co *NoticeConsumer) ReadMessages(ctx context.Context, limit int) ([]any, error) {
...
func (co *NoticeConsumer) CancelMessages(ctx context.Context, messages []any) error {
	...
	for i, message := range messages {
		...
		return mr.ErrInternalInvalidType.New("unknown", entity.ModelNameNotice+"["+strconv.Itoa(i)+"]")
	}
...
func (co *NoticeConsumer) CommitMessage(ctx context.Context, message any, preCommit func(ctx context.Context) error) error {
	...
	return mr.ErrInternalInvalidType.New("unknown", entity.ModelNameNotice)
}
