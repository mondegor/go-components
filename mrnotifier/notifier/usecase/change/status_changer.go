...
func (co *StatusChanger) ChangeProcessingToRetryByTimeout(ctx context.Context, limit int) error {
...
func (co *StatusChanger) ChangeRetryToReady(ctx context.Context, limit int) error {
