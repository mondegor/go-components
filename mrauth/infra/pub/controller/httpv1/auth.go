...
func (ht *Auth) Signup(w http.ResponseWriter, r *http.Request) error {
	...
	op, err := ht.useCaseCreateUser.Perform(r.Context(), req.Realm, lz.Language(), req.UserEmail)
	if err != nil {
...
func (ht *Auth) Signin(w http.ResponseWriter, r *http.Request) error {
	...
	op, err := ht.useCaseConfirmAuthUser.Perform(r.Context(), req.Realm, lz.Language(), req.UserLogin)
	if err != nil {
...
func (ht *Auth) OpenSession(w http.ResponseWriter, r *http.Request) error {
	...
	op, err := ht.useCaseConfirmOperation.Perform(r.Context(), lz.Language(), req.Token, req.Secret)
	if err != nil {
