...
const (
	Opened            Enum = iota + 1 // действующий
	Closed                            // закрытый
	Revoked                           // отозванный
	UnexpectedRevoked                 // неожиданно отозванный
)

const (
	enumLast = uint8(UnexpectedRevoked)
...
var (
	enumKeys = map[Enum]string{
		...
		Closed:            "CLOSED",
		Revoked:           "REVOKED",
		UnexpectedRevoked: "UNEXPECTED_REVOKED",
	}
	...
	enumValues = map[string]Enum{
		...
		"CLOSED":             Closed,
		"REVOKED":            Revoked,
		"UNEXPECTED_REVOKED": UnexpectedRevoked,
	}
)
