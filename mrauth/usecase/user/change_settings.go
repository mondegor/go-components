...
//
// Оба обновления идут одной транзакцией: профиль, разошедшийся с областью действия токенов,
// поднял бы у клиента признак "настройки ещё не применены" (см. httpv1.isSettingsPending),
// который сам бы уже не погас - продление сессии перенесло бы в новый токен прежние значения.
