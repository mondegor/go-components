...
func NewSettingsGetter(storage *SettingsReloader) *SettingsGetter {
...
func (co *SettingsGetter) Get(_ context.Context, id uint64) (string, error) {
	...
	return "", mr.ErrInternalKeyNotFoundInSource.New(id, settingsMapName)
}
...
func (co *SettingsGetter) GetList(_ context.Context, id uint64) ([]string, error) {
	...
	return nil, mr.ErrInternalKeyNotFoundInSource.New(id, settingsMapName)
}
...
func (co *SettingsGetter) GetInt64(_ context.Context, id uint64) (int64, error) {
	...
	return 0, mr.ErrInternalKeyNotFoundInSource.New(id, settingsMapName)
}
...
func (co *SettingsGetter) GetBool(_ context.Context, id uint64) (bool, error) {
	...
	return false, mr.ErrInternalKeyNotFoundInSource.New(id, settingsMapName)
}
